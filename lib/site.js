...
export const VENTURES = [
  ...
  { label: 'Synheart', href: 'https://synheart.ai', note: 'human-state AI research' },
  { label: 'Anipreneur', href: 'https://www.youtube.com/@anipreneur', note: 'faceless YouTube' },
  { label: 'Inlink AI', href: 'https://inlinkai.com', note: 'AI support agency' },
];
...
export const NEWSLETTER_LINKS = [
  { label: 'What you get', href: '/newsletter#what', note: 'three promises' },
